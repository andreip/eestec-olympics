...
DATABASES = {
    'default': {
        ...
        'NAME': 'eestec_db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '2mo#ji_96vg0zrgjnjf0q4i_b6s)q5sr^y(-9=lf%wwb@zjb1t'
...
ROOT_URLCONF = 'eestec_site.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'eestec_site.wsgi.application'
